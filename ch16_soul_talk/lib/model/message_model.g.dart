...
const MessageModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'isMine': PropertySchema(id: 1, name: r'isMine', type: IsarType.bool),
    r'message': PropertySchema(id: 2, name: r'message', type: IsarType.string),
    r'point': PropertySchema(id: 3, name: r'point', type: IsarType.long),
  },
...
extension MessageModelQueryFilter
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition> isMineEqualTo(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'isMine', value: value),
      );
    });
  }
  ...
  pointIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNull(property: r'point'),
      );
    });
  }
  ...
  pointIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        const FilterCondition.isNotNull(property: r'point'),
      );
    });
  }
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition> pointEqualTo(
    ...
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'point', value: value),
      );
    });
  }

  QueryBuilder<MessageModel, MessageModel, QAfterFilterCondition>
  pointGreaterThan(int? value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
